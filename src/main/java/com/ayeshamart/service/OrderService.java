...
/**
 * Checkout business logic (Phase 5).
 *
 * <p>{@link #placeOrder(long)} converts the buyer's database-backed cart
 * into a PENDING order inside a single database transaction:
 * <ol>
 ...
 * </ol>
 * Every amount (subtotal and total) is calculated on the server.
 */
